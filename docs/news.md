...
- [**SSSOM Mappings Template**](../resources/mappings_template.xlsx) — Changed: added basic input validation and displayed contextual information when boxes are selected.
